package com.tismenetski.recipe.bootstrap;

import com.tismenetski.recipe.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes()
    {
        ...
        guacRecipe.setDirections("1 Cut the avocado, remove flesh: Cut the avocados in half." +
                ...
                " The acid in the lime juice will provide some balance to the richness" +
                " of the avocado and will help delay the avocados from turning brown.\n" +
                "\n" +
                "Add the chopped onion, cilantro, black pepper, and chiles. Chili peppers vary" +
                " individually in their hotness. So, start with a half of one chili pepper" +
                ...
                " place plastic wrap on the surface of the guacamole and press down" +
                " to cover it and to prevent air reaching it." +
                " (The oxygen in the air causes oxidation which will turn the guacamole brown.)" +
                " Refrigerate until ready to serve.");

        Notes guacNotes=new Notes();
        guacNotes.setRecipeNotes("Quick guacamole: For a very quick guacamole just take a 1/4 cup of salsa" +
                " and mix it in with your mashed avocados."+
                "Guacamole has a role in the kitchen beyond a party dip," +
                " of course. It’s great scooped on top of nachos and also makes an excellent" +
                " topping or side for enchiladas, tacos, grilled salmon, or oven-baked chicken.\n" +
                "\n" +
                "Guacamole is great in foods, as well." +
                " Try mixing some guacamole into a tuna sandwich or your next batch of deviled eggs.");
        ...
        */
        ...
        tacosRecipe.getIngredients().add(new Ingredient("cherry tomatoes, halved",new BigDecimal(4),eachUom,tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("red onion, thinly sliced",new BigDecimal(".5"),pintUom,tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Roughly chopped cilantro",new BigDecimal(".25"),eachUom,tacosRecipe));
        ...
        */
        ...
        tacosRecipe.addIngredient(new Ingredient("cherry tomatoes, halved",new BigDecimal(4),eachUom));
        tacosRecipe.addIngredient(new Ingredient("red onion, thinly sliced",new BigDecimal(".5"),pintUom));
        tacosRecipe.addIngredient(new Ingredient("Roughly chopped cilantro",new BigDecimal(".25"),eachUom));
